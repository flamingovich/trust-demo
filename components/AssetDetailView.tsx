  ...
  return (
    <div className="h-full bg-white dark:bg-black text-black dark:text-white flex flex-col animate-ios-slide-in relative transition-colors duration-300">
      <div className="px-6 pt-4 pb-4 flex items-center justify-between shrink-0">
        ...
        <h2 className="text-[17px] font-medium">{asset.name}</h2>
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar">
        ...
        <div className="flex justify-center space-x-4 px-6 mb-10">
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-[12px] font-medium text-zinc-900 dark:text-zinc-200">{t.send}</span>
          </div>
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-[12px] font-medium text-zinc-900 dark:text-zinc-200">{t.receive}</span>
          </div>
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-[12px] font-medium text-zinc-900 dark:text-zinc-200">{t.swap}</span>
          </div>
        </div>

        {/* Transaction History */}
        <div className="px-6 pb-20">
          <h3 className="text-zinc-400 text-[11px] font-medium uppercase tracking-[0.2em] mb-4">
            {t.history}
          </h3>
              ...
              {transactions.map(tx => (
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="font-medium text-[15px]">{tx.type === 'receive' ? t.receive : tx.type === 'swap' ? t.swap : t.send}</p>
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900/50 rounded-[32px] p-6 space-y-4 border border-zinc-100 dark:border-white/5 shadow-inner">
                ...
                {selectedTx.address && (
                  <div className="flex justify-between items-start pt-4 border-t border-zinc-200/50 dark:border-white/5">
                    <span className="text-zinc-400 font-medium uppercase text-[10px] tracking-widest mt-1">{t.recipient}</span>
