  ...
  return (
    <div className="h-full bg-white dark:bg-black text-black dark:text-white flex flex-col animate-ios-slide-in relative transition-colors duration-300">
      <div className="px-6 pt-4 pb-4 flex items-center justify-between shrink-0">
        ...
        <h2 className="text-[17px] font-semibold">{asset.name}</h2>
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar">
        ...
        <div className="flex flex-col items-center py-10 px-6">
          <div className="w-20 h-20 rounded-full bg-zinc-50 dark:bg-zinc-900 p-2 mb-6 shadow-sm">
          ...
          <div className={`mt-2 px-3 py-1 rounded-full text-xs font-semibold ${asset.change24h >= 0 ? 'bg-green-500/10 text-green-500' : 'bg-red-500/10 text-red-500'}`}>
        ...
        <div className="flex justify-center space-x-4 px-6 mb-10">
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-[12px] font-semibold text-zinc-900 dark:text-zinc-200">{t.send}</span>
          </div>
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-[12px] font-semibold text-zinc-900 dark:text-zinc-200">{t.receive}</span>
          </div>
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-[12px] font-semibold text-zinc-900 dark:text-zinc-200">{t.swap}</span>
          </div>
        </div>

        {/* Transaction History */}
        <div className="px-6 pb-20">
          <h3 className="text-zinc-400 text-[11px] font-semibold uppercase tracking-[0.2em] mb-4">
            {t.history}
          </h3>
          {transactions.length === 0 ? (
            <div className="py-10 text-center text-zinc-500 opacity-60 italic font-normal">
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-[11px] text-zinc-400 font-normal">
                      ${formatUSD(tx.amount * asset.priceUsd)}
                    </p>
                  </div>
                </div>
              ))}
            ...
            <div className="space-y-4">
              <div className="bg-zinc-50 dark:bg-zinc-900/50 rounded-[32px] p-6 space-y-4 border border-zinc-100 dark:border-white/5 shadow-inner">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-zinc-200/50 dark:border-white/5">
                  ...
                  <span className="font-semibold text-[13px]">{selectedTx.networkFee || '$0,00'}</span>
                </div>
              </div>
